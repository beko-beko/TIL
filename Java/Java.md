...
　- インターフェースからインターフェースへの継承<br>
 	- `public interface インターフェース名 extends 親インターフェース名 { ... }`<br>
  	- 複数のインターフェースを継承したインターフェースを生成する<br>
   	  - インターフェースの多重継承も可能<br>
	    - `public interface インターフェース名 extends 親インターフェース名1, 親インターフェース名2... { ... }`<br>
